...
AUTOMAKE_INSTALLDIR=${PREFIX}/tools/automake/${AUTOMAKE_VERSION}
...
cp ${SCRIPT_DIR}/${SCRIPT_NAME} \
   ${AUTOMAKE_INSTALLDIR}/build-automake-${AUTOMAKE_VERSION}.sh

# Write module 

mkdir -p ${PREFIX}/modules/automake

cat > ${PREFIX}/modules/automake/${AUTOMAKE_VERSION} << EOF
#%Module1.0#####################################################################
##
## null modulefile
##
