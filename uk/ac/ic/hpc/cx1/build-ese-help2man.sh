...
HELP2MAN_INSTALLDIR=${PREFIX}/tools/ese-help2man/${HELP2MAN_VERSION}
...
cp ${SCRIPT_DIR}/${SCRIPT_NAME} \
   ${HELP2MAN_INSTALLDIR}/build-ese-help2man-${HELP2MAN_VERSION}.sh

# Write module 

mkdir -p ${PREFIX}/modules/ese-help2man
cat > ${PREFIX}/modules/ese-help2man/${HELP2MAN_VERSION} << EOF
#%Module1.0#####################################################################
##
## null modulefile
##
